...
document
  .querySelector("#random_quote_btn")
  .addEventListener("click", generatePar);
function generatePar() {
  let el = document.createElement("p");
  el.innerHTML = pickRandomQuote(inspirationalQuotes);
  el.style.backgroundColor = getRandomHexColor();
  document.querySelector("#quotes_container").appendChild(el);
}
...
function testFunc() {
  ...
  div.innerHTML = `
    ...
    <img src = "https://i.imgur.com/2bIEJ7P.png">
  <div class="card-body">
    ...
    `;
  document.getElementsById("quotes_container").appendChild(div);
}
